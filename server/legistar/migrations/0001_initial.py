    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "legistar_guid",
                    models.CharField(
                        help_text="The GUID of the action on the Legistar site.",
                        max_length=36,
                    ),
                ),
                (
                ...
                (
                    "schema_data",
                    models.JSONField(default=dict, help_text="The raw schema data."),
                ),
            ],
            options={
                "verbose_name": "Action",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "summarizer_name",
                    models.CharField(
                        help_text="The name of the MeetingSummarizerCallable.",
                        max_length=255,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "summary",
                    models.TextField(help_text="The summary of the legislation."),
                ),
                (
                    "summarizer_name",
                    models.CharField(
                        help_text="The name of the summarizer.", max_length=255
                    ),
                ),
                (
                    "legislation",
